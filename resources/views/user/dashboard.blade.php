...
@section('content')
    <div>
        <div
            class=" w-full custom-bg items-center rounded-2xl flex justify-between px-6 py-10 md:py-16 relative overflow-hidden">

            <!-- Overlay -->
            <div class="absolute inset-0 bg-black/20 z-0"></div>

            <div class="relative z-50">
                <h1 class="text-white text-xl font-semibold">Welcome back Cyril 👋🏻</h1>
                <p class="text-white font-[16px]">Every lesson brings you closer to your goal 🚀</p>
            </div>
            <div class="absolute right-2 z-10">
                <img class="opacity-40 md:opacity-100" src="{{ asset('dashboard_assets/images/img/undraw.png') }}"
                    alt="undraw">
            </div>
        </div>
        ...
        <div class="mt-6 ">
                ...
                <div class="bg-[#ffffff] border border-[#D9D9D9] rounded-2xl p-6 shadow-inner">
                    ...
                    <div class="flex items-start gap-4 mb-4">
                        ...
                        <div class="flex-1 min-w-0">
                            <h2 class="text-lg text-black font-semibold mb-1">Cloud Computing with AWS and DevOps Basics
                            </h2>
            ...
            <div class="mt-7">
                ...
                <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 place-items-center">
                    <!-- single course card -->
                    <div class="bg-white shadow-sm rounded-2xl p-2 md:p-4 overflow-hidden w-full max-w-sm">
                        <!-- Header with Figma logo and badges -->
                        <div class="bg-figma-purple  relative">
                            <div
                                class="rounded-[10px] w-100 h-[180px]  md:h-[140px] overflow-hidden bg-cover bg-center bg-no-repeat">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <a href="{{ route('user.course-details') }}"
                                    class="text-[#E68815] font-normal text-sm hover:underline">
                                    View Details
                                </a>
                            </div>

                            <button
                                class="w-full bg-[#E68815] hover:bg-[#ffad48] text-white py-3 px-4 rounded-[100px] font-medium transition-colors flex items-center justify-center gap-0.5">

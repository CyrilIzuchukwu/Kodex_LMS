        ...
        <tr>
            <td>
                ...
                <div class="content">
                    ...
                    <p class="subtitle">{{ $email_subject }}</p>
                    <p>{!! $email_content !!}</p>
                    <div class="cta-section">
                        <a href="{{ config('app.url') }}" class="button">Visit Website</a>
                    </div>
                    <div class="support-text">
                        <p>Need help? Our support team is available 24/7 to assist you. Contact us at <a href="mailto:{{ site_settings()?->site_email }}" class="support-email">{{ site_settings()?->site_email }}</a></p>
                    </div>
                </div>
                <div class="footer">

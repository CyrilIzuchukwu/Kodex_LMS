            ...
            <td>
                <div class="header">
                    <div class="logo-container">
                        ...
                        <div class="welcome-badge">Password Reset Confirmation</div>
                    </div>
                </div>
                <div class="content">
                    <h1 class="greeting">Password Reset Successful, {{ $user->name }}!</h1>
                    <p class="subtitle">Your {{ config('app.name') }} account password for {{ $user->email }} has been successfully reset.</p>
                    ...
                    <div class="support-text">
                        <p>If you did not initiate this password reset, please contact our support team immediately at <a href="mailto:{{ site_settings()?->site_email }}" class="support-email">{{ site_settings()?->site_email }}</a> to secure your account.</p>
                    </div>
                </div>
                <div class="footer">

            ...
            <td>
                <div class="header">
                    <div class="logo-container">
                        ...
                        <div class="welcome-badge">Your OTP Code</div>
                    </div>
                </div>
                <div class="content">
                    <h1 class="greeting">Your One-Time Password</h1>
                    <p class="subtitle">Hello,</p>
                    <p>You've requested a one-time password to verify your identity on {{ config('app.name') }}.</p>
                    <div class="otp-code">{{ $token }}</div>
                    <p>This code is valid for the next 20 minutes. Do not share it with anyone.</p>
                    <div class="support-text">
                        <p>If you didn't request this OTP, please contact our support team immediately at <a href="mailto:{{ site_settings()?->site_email }}" class="support-email">{{ site_settings()?->site_email }}</a>.</p>
                    </div>

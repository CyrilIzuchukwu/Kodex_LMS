...
<div class="container">
    ...
    <div class="content">
        ...
        <p>We received a request to reset the password for your Kodex account associated with {{ $user->email }}.</p>
        <p>Click the button below to reset your password. This link will expire in 60 minutes for security reasons.</p>
        <a href="{{ $resetUrl }}" class="button">Reset Password</a>
        <p>If you did not request a password reset, please ignore this email or contact our support team at support@kodex.com.</p>

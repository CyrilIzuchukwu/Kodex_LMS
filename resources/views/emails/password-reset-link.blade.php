...
<head>
    ...
    <title>Reset Your Kodex Password</title>
    <style>
            ...
            <td>
                <div class="header">
                    <div class="logo-container">
                        ...
                        <div class="welcome-badge">Password Reset Request</div>
                    </div>
                </div>
                <div class="content">
                    <h1 class="greeting">Reset Your Password, {{ $user->name }}!</h1>
                    <p class="subtitle">We received a request to reset the password for your {{ config('app.name') }} account associated with {{ $user->email }}.</p>
                    ...
                    <div class="support-text">
                        <p>If you did not request a password reset, please ignore this email or contact our support team at <a href="mailto:{{ site_settings()?->site_email }}" class="support-email">{{ site_settings()?->site_email }}</a>.</p>
                    </div>

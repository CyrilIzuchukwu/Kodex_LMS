    ...
    <div class="px-1 md:px-6 lg:px-8 py-4 md:py-6 mb-5">
        <div class="glass-effect header">
            <div class="header-content">
                ...
                <div style="flex: 1;">
                    <h1>Notifications</h1>
                    <p>Stay updated with your course activities and student interactions.</p>
                </div>
            </div>
        </div>
            ...
            <div class="mb-6 md:mb-8 animate-fade-in">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2 md:gap-3">
                        <form action="{{ route('instructor.notifications.markAllRead') }}" method="POST" class="inline">
                            @csrf
        ...
        <div class="mb-6">
            <div class="flex flex-wrap gap-2 bg-white p-2 rounded-xl shadow-sm border">
                ...
                <a href="{{ route('instructor.notifications.index', ['filter' => 'unread']) }}"
                ...
                <a href="{{ route('instructor.notifications.index', ['filter' => 'student']) }}"
                ...
                <a href="{{ route('instructor.notifications.index', ['filter' => 'course']) }}"
                ...
                <a href="{{ route('instructor.notifications.index', ['filter' => 'system']) }}"
        ...
        <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-75 backdrop-blur-sm flex items-center justify-center z-[9999] hidden p-4">
            <div class="logout-modal-content bg-white rounded-[20px] md:rounded-[30px] shadow-lg w-full max-w-sm md:max-w-md h-auto p-4 md:p-6 flex flex-col items-center justify-center z-[10000]">
                ...
                <form id="deleteAllForm" action="{{ route('instructor.notifications.deleteAll') }}" method="POST" class="flex-1">
                    @csrf
                    @method('DELETE')
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.notification-item').forEach(item => {
                item.addEventListener('click', function (e) {
                    ...
                    if (!isRead) {
                        ...
                        fetch(`/instructor/notifications/${notificationId}/mark-read`, {
                            method: 'POST',
                            headers: {
            ...
            document.querySelectorAll('.delete-notification').forEach(btn => {
                btn.addEventListener('click', function (e) {
                    ...
                    deleteIndividualForm.action = `/instructor/notifications/${currentDeleteNotificationId}/delete`;

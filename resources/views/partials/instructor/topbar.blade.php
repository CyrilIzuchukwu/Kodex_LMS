...
<!-- Header -->
<div class="bg-white/80 backdrop-blur-md border-b border-gray-200/50 sticky top-0 z-50">
    <div class="container mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                <img src="{{ asset('assets/auth/Kodex-logo.png') }}" class="md:px-10 block" alt="">
            </div>
                        ...
                        <div class="max-h-80 overflow-y-auto">
                            ...
                            @if (auth()->user()->notifications->count() > 0)
                                <div class="p-3 text-center">
                                    <a href="{{ route('instructor.notifications.index') }}" class="text-blue-600 hover:text-blue-700 text-sm font-medium">
                ...
                <div class="relative inline-block">
                    ...
                    <div id="profile-panel" class="hidden fixed top-16 right-4 bg-white rounded-xl shadow-xl border border-gray-200 w-80 max-h-96 overflow-hidden z-40" style="max-width: calc(100vw - 2rem);">
                        ...
                        <ul class="py-2" aria-labelledby="user-menu-button">
                            <li>
                                <a href="{{ route('instructor.profile.index') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-[#EB8C22]">

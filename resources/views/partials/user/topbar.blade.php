...
<div class="top-header">
    <div class="header-bar flex justify-between">
        <div class="flex items-center space-x-4">
            ...
            <a id="close-sidebar" class="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-[20px] text-center bg-gray-50 dark:bg-slate-800 hover:bg-gray-100 dark:hover:bg-slate-700 border border-gray-100 dark:border-gray-800 text-slate-900 dark:text-white rounded-full" href="javascript:void(0)">
                <i data-feather="menu" class="size-4"></i>
            </a>

            <!-- Logo -->
            <a href="{{ route('user.dashboard') }}" class="xl:hidden block me-2 mt-2 md:mt-0 {{ request()->routeIs('user.dashboard') ? 'bg-gray-100' : '' }}">
        ...
        <div class="flex items-center space-x-4 mr-4">
            ...
            <div class="relative inline-block mr-1">
                <button type="button" class="size-9 flex items-center justify-center text-sm bg-gray-100 rounded-full p-1.5 hover:bg-gray-200 focus:ring-4 focus:ring-[#E68815]/30 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-[#E68815]/50" id="notification-menu-button" aria-expanded="false" data-dropdown-toggle="notification-dropdown" data-dropdown-placement="bottom">
                    ...
                    <div class="max-h-64 overflow-y-auto">
                                    ...
                                    <div class="flex items-start space-x-3">
                                        <div class="flex-shrink-0">
                                            <div
                                                ...
                                                <i data-feather="bell" class="size-4 text-[#EB8C22]"></i>
                                            </div>
                                        </div>
                        ...
                        @empty
                            <div class="px-4 py-6 text-center">
                                <i data-feather="bell" class="size-8 text-gray-400 mx-auto mb-2"></i>
            ...
            <div class="inline-block relative">
                <a href="{{ route('user.cart') }}" class="dropdown-toggle size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-[20px] text-center bg-gray-50 hover:bg-gray-100 border border-gray-100 rounded-full shadow-md {{ request()->routeIs('user.carts') ? 'bg-gray-100' : '' }}" type="button">
            ...
            <div class="relative inline-block">
                <button type="button" class="size-9 flex items-center justify-center text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-[#EB8C22]/30" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                ...
                <div class="z-50 hidden mt-2 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-lg border border-gray-200 w-56 absolute right-3 sm:right-3 md:right-3 lg:right-3 xl:right-3" id="user-dropdown" style="max-width: calc(100vw - 2rem);">
                    ...
                    <ul class="py-2" aria-labelledby="user-menu-button">
                        <li>
                            <a href="{{ route('user.profile.index') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-[#EB8C22] {{ request()->routeIs('user.profile.*') ? 'bg-gray-50 text-[#EB8C22]' : '' }}">

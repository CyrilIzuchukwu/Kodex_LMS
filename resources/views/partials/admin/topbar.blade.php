            ...
            <div class="relative inline-block">
                ...
                <div id="profile-panel" class="hidden fixed top-16 right-4 bg-white rounded-xl shadow-xl border border-gray-200 w-80 max-h-96 overflow-hidden z-40" style="max-width: calc(100vw - 2rem);">
                    ...
                    <ul class="py-2" aria-labelledby="user-menu-button">
                        <li>
                            <a href="{{ route('admin.profile.index') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-[#EB8C22]">
                        ...
                        <li>
                            <a href="{{ route('admin.settings.index') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-[#EB8C22]">

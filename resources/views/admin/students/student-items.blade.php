    ...
    <tr class="hover:bg-gray-50">
        ...
        <td class="px-2 md:px-6 py-4">
            <div class="flex justify-center space-x-2">
                ...
                <a href="{{ route('admin.students.show', $user->id) }}" class="group relative inline-flex items-center p-2 text-sm font-medium text-gray-500 hover:text-gray-700 bg-transparent rounded-lg hover:bg-gray-100 focus:outline-none" aria-label="View">
                ...
                <a href="{{ route('admin.students.edit', $user->id) }}" class="group relative inline-flex items-center p-2 text-sm font-medium text-gray-500 hover:text-gray-700 bg-transparent rounded-lg hover:bg-gray-100 focus:outline-none" aria-label="Edit">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

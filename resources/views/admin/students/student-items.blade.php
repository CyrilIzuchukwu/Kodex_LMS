            ...
            <div class="flex justify-center relative" x-data="{ open: false }" @click.away="open = false">
                ...
                <div x-show="open"
                    ...
                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
                        ...
                        <li>
                            <a data-user-id="{{ $user->id }}" class="delete-user flex items-center px-4 py-2 text-red-600 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-red-400 dark:hover:text-white">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

 ...
 <div x-data="{ open: false }"
         ...
         <div class="flex items-center gap-4">
             ...
             <div class="inline-block">
                 ...
                 <button @click="open = true"
                     class="bg-[#E68815] px-4 py-3 rounded-full font-medium text-white hover:bg-[#cc6f0f] focus:outline-none focus:ring-2 focus:ring-[#E68815]">
                     + Add Instructors
                 </button>
                                 ...
                                 <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                     <div>
                                         ...
                                         <input name="first_name" type="text"
                                             class="w-full border border-gray-300 rounded-lg p-2 focus:border-[#E68815] focus:ring-1 focus:ring-[#E68815]"
                                     ...
                                     <div
                                         ...
                                         <div class="space-y-5">
                                             <div class="radio-item flex gap-4 items-center space-x-3">
                                                 <input type="radio" name="course" id="web" value="web" class="relative w-4 h-4 border-2 rounded-full bg-white cursor-pointer 
  ...
  checked:border-[#E68815] checked:bg-[#E68815] accent-[#E68815]">
                                             ...
                                             <div class="radio-item flex gap-4 items-center space-x-3">
                                                 <input type="radio" name="course" id="ui-ux" value="ui-ux" class="relative w-4 h-4 border-2 rounded-full bg-white cursor-pointer 
  transition-all duration-200 ease-in-out hover:border-[#E68815] 
  focus:outline-none focus:ring-2 focus:ring-[#E68815] 
  checked:border-[#E68815] checked:bg-[#E68815] accent-[#E68815]">
                                             ...
                                             <div class="radio-item flex gap-4 items-center space-x-3">
                                                 <input type="radio" name="course" id="data" value="data" class="relative w-4 h-4 border-2 rounded-full bg-white cursor-pointer 
  transition-all duration-200 ease-in-out hover:border-[#E68815] 
  focus:outline-none focus:ring-2 focus:ring-[#E68815] 
  checked:border-[#E68815] checked:bg-[#E68815] accent-[#E68815]">
                                             ...
                                             <div class="radio-item flex gap-4 items-center space-x-3">
                                                 <input type="radio" name="course" id="mobile" value="mobile" class="relative w-4 h-4 border-2 rounded-full bg-white cursor-pointer 
  transition-all duration-200 ease-in-out hover:border-[#E68815] 
  focus:outline-none focus:ring-2 focus:ring-[#E68815] 
  checked:border-[#E68815] checked:bg-[#E68815] accent-[#E68815]">
                                 ...
                                 <div class="mt-4 mb-5">
                                     ...
                                     <div class="border border-gray-300 rounded-lg bg-white">
                                         <textarea placeholder="Write something..." rows="4"
                                             class="w-full px-4 py-3 bg-transparent text-gray-900 placeholder:text-gray-500 resize-none focus:outline-none rounded-t-lg"></textarea>
                                         <div
                                             ...
                                             <button class="p-1 hover:bg-gray-200 rounded">
                                                 <svg class="w-4 h-4 text-gray-600" fill="none" stroke="currentColor"
                                                     ...
                                                     <path stroke-linecap="round" stroke-linejoin="round"
                                                         stroke-width="2" d="M6 4h8a4 4 0 014 4 4 4 0 01-4 4H6z"></path>
                                                     <path stroke-linecap="round" stroke-linejoin="round"
     ...
     <div class="w-auto bg-white rounded-[30px] px-10 py-6 shadow-sm overflow-hidden">
         ...
         <div class="overflow-x-auto bg-white mb-20 rounded-[30px] ">
             <table class="min-w-full divide-y divide-gray-200 border-collapse">
                 <thead class="bg-[#EDEDED] ">
                     <tr>
                         <th
                             class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase border-r  border-gray-300">
                         </th>
                         <th
                             class="px-6 py-4 text-left text-[16px] font-medium text-gray-500 uppercase border-r border-gray-300">
                             Instructor Name</th>
                         <th
                             class="px-6 py-4 text-left text-[16px] font-medium text-gray-500 uppercase border-r border-gray-300">
                             Email</th>
                         ...
                         <th
                             class="px-6 py-4 text-left text-[16px] font-medium text-gray-500 uppercase border-r border-gray-300">
                             Assigned Course</th>
                         <th class="px-6 py-4 text-center text-[16px] font-medium text-gray-500 uppercase">Action</th>
                     </tr>
                 ...
                 <tbody class="bg-[#fcfafa] divide-y divide-gray-200">
                     <tr class="hover:bg-gray-50">
                         ...
                         <td class="px-6 py-4 text-sm text-center">
                             <div class="flex items-center justify-center gap-2">
                                 ...
                                 <button
                                     class="px-3 py-1 bg-amber-500 text-white rounded-full hover:bg-amber-600 text-sm">Edit</button>
                    ...
                    " class="px-6 py-3 rounded-full bg-[#E30800] text-white hover:bg-red-600">
                     ...
                     <tr class="hover:bg-gray-50">
                         ...
                         <td class="px-6 py-4 text-sm font-medium text-gray-800">Jane Smith</td>
                         <td class="px-6 py-4 text-sm text-gray-700">jane@example.com</td>
                         <td class="px-6 py-4 text-sm text-gray-700">+987654321</td>
                         <td class="px-6 py-4 text-sm text-gray-700">Graphic Design</td>
                         <td class="px-6 py-4 text-sm text-center">
                             <div class="flex items-center justify-center gap-2">
                                 ...
                                 <div x-cloak x-data="{ open: false }" class="inline-block">
                                     ...
                                     <div x-show="open" x-transition.opacity
                                         ...
                                         <div @click.away="open = false" x-transition.scale
                                             ...
                                             <img src="{{ asset('dashboard_assets/images/img/gradient.png') }}"
                                                 alt="delete">
                                             <h2 class="text-lg font-semibold text-gray-800 mb-4">Delete Student?</h2>
                                             <p class="text-gray-600 mb-6">
                                                 Are you sure you want to remove <span class="font-semibold">Jane
                                                     Doe</span> from the system? This action cannot be undone.
                                             </p>
         ...
         <div class="flex justify-between text-black font-medium items-center">
             <div>
                 <p>Showing <span>1</span> to 5 of 5 entries</p>
             </div>
             <div class="flex gap-2">
                 <button
                     class="bg-[#EDEDED] text-black px-10 py-3 rounded-full font-medium hover:bg-gray-200">Prev</button>
                 <span class="border px-6 py-3 rounded-full bg-white text-black">5</span>
                 <button
                     class="bg-[#E68815] text-white px-10 py-3 rounded-full font-medium hover:bg-amber-600">Next</button>
             </div>
         </div>
     </div>

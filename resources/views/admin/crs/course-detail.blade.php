     ...
     <div>
         ...
         <div class="max-w-7xl mx-auto ">
             <div class=" space-x-4  mb-10">
                 <!-- Step Label -->
                 <div
                     class="mb-8 inline-block px-4 py-2  bg-[#EDEDED] rounded-[10px] shadow-sm border border-[#929292] relative top-0 left-[20rem]">
                 ...
                 <div class="flex items-center justify-center space-x-0">
                     ...
                     <div class="relative flex items-center">
                         <div
                            class="w-12 h-12 flex items-center justify-center rounded-full bg-orange-500 text-white font-bold shadow-[inset_0_4px_6px_rgba(0,0,0,0.3)]">
                             1
                         </div>
                         <!-- Line to Next -->
             ...
             <div class="bg-white p-6 rounded-[20px] shadow-md mx-auto">
                 ...
                 <div class="flex items-center mb-6">
                     <div class="w-10 h-10 flex items-center justify-center rounded-full bg-orange-500 text-white mr-2">
                 ...
                 <form class="space-y-6">
                     ...
                     <div>
                         ...
                         <input type="text" placeholder="Title"
                             class="w-full border border-[#E1E1E1] text-[#1B1B1B] rounded-md px-4 py-2 focus:border-[#E68815] focus:outline-none focus:ring-2 focus:ring-orange-500" />
                     </div>
                     ...
                     <div>
                         ...
                         <div class="border border-[#E1E1E1] rounded-lg bg-white">
                             <textarea placeholder="Write something..." rows="4"
                                 class="w-full px-4 py-3 bg-transparent text-gray-900 placeholder:text-gray-500 resize-none focus:outline-none focus:border-none focus:ring-[#E68815] rounded-t-lg border-[#E1E1E1]"></textarea>
                             <div
                     ...
                     <div class="grid grid-cols-2 gap-4">
                         <div>
                             ...
                             <input type="text" placeholder="Price"
                                 class="w-full border border-[#E1E1E1] rounded-md text-[#1B1B1B] px-4 py-2 focus:outline-none focus:border-[#E68815] focus:ring-2 focus:ring-orange-500" />
                         </div>

                         <div>
                             <label class="block text-[#1B1B1B] text-sm font-medium mb-1">Category*</label>
                             <select
                                 class="w-full border border-[#E1E1E1] rounded-md px-4 py-2 focus:border-[#E68815] focus:outline-none focus:ring-0 focus:ring-orange-500 text-[#1B1B1B] ">
                     ...
                     <!-- Button -->
                     <button type="submit"
                         class="w-full bg-orange-500 hover:bg-orange-600 text-white font-medium py-3 rounded-full">
                         Save and continue
                     </button>
                 </form>
             </div>

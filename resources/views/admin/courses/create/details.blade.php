...
@section('content')
    ...
    <div class="max-w-7xl mx-auto ">
        ...
        <div class="bg-white p-6 rounded-[20px] shadow-md mx-auto">
            ...
            <!-- Form -->
            <form id="course-create-form" action="{{ route('admin.courses.add.store.details') }}" method="POST" class="space-y-4 sm:space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <div class="border border-gray-300 rounded-lg bg-white">
                        ...
                        <input type="hidden" name="summary" id="details" value="{{ old('summary', $sessionDetails['summary'] ?? '') }}">
                    </div>
                    @error('summary')

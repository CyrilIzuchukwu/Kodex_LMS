 ...
 @section('content')
     ...
     <div x-data="{ open: false }" x-init="$watch('open', value => { document.body.classList.toggle('overflow-hidden', value) })">
         <p class="text-[18px] font-medium text-[#5D5D5D] mb-16">User Management > <span
                 class="text-[#848484]">Students</span></p>
         <div class="flex justify-between items-center mb-6">
             ...
             <div class="flex gap-4">
                 <button
                     class="bg-[#F5CE9F] text-[#8C530D]  text-[14px] px-10 py-3 rounded-full  font-medium hover:bg-[#e6bb85]">
                     All
                 </button>
         ...
         <div class="w-auto bg-white rounded-[30px] px-3 py-3 shadow-sm overflow-hidden">
                         ...
                         <tr class="hover:bg-gray-50 text-center">
                             ...
                             <td class="px-6 py-4 text-sm text-center">
                                 <div class="flex items-center justify-center gap-2">
                                     <button
                                         class="px-3 py-1 bg-gray-100 text-gray-700 rounded-full hover:bg-gray-200 text-sm">
             ...
             <div class="flex justify-between text-black font-medium items-center">
                 ...
                 <div class="flex gap-2">
                     <button class="bg-[#EDEDED] text-black px-10 py-3 text-sm rounded-full font-medium hover:bg-gray-200">
                         Prev
                     </button>
                     <span class="border px-6 py-3 rounded-full text-sm bg-white text-black">5</span>
                     <button
                         class="bg-[#E68815] text-white px-10 py-3 text-sm rounded-full font-medium hover:bg-amber-600">
                         Next
                     </button>
                 </div>
             </div>

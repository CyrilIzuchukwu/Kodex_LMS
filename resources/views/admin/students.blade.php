 ...
 <div x-data="{ open: false }"
     ...
     <p class="text-[20px] font-medium text-[#5D5D5D] mb-16">User Management  > <span class="text-[#848484]">Students</span></p>
     <div class="flex justify-between items-center mb-6">
             ...
             <div class="inline-block">
                 ...
                 <div x-cloak x-show="open" x-transition.opacity x-trap="open" @keydown.escape="open = false"
                     ...
                     <div @click.stop @click.away="open = false" x-transition.scale
                         class="bg-white rounded-lg shadow-lg w-[70vw] p-16 space-y-4 z-[10000] self-start mt-8 mb-8">
         ...
         <div class="flex gap-4">
             ...
             <div x-data="{ open: false, selected: 'Enrolled Course' }" class="relative w-64">
                 <!-- Dropdown button -->
                 ...
                 <div x-show="open" @click.away="open = false"
                     ...
                     <ul>
                         <template
                             x-for="option in ['Enrolled Course', 'Web Development', 'Product Design', 'Data Analysis', 'Mobile App Development']">
                     ...
                     <tr class="hover:bg-gray-50">
                         ...
                         <td class="px-6 py-4 text-sm text-center">
                             <div class="flex items-center justify-center gap-2">
                                 <button
                                     class="px-3 py-1 bg-gray-100 text-gray-700 rounded-full hover:bg-gray-200 text-sm">View</button>
                                 <button
